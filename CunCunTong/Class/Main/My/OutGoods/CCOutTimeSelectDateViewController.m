//
//  CCOutTimeSelectDateViewController.m
//  CunCunTong
//
...
@interface CCOutTimeSelectDateViewController ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation CCOutTimeSelectDateViewController
...
- (void)initData {
    ...
    NSString *path = [NSString stringWithFormat:@"/app0/backgetdate/?center_sku_id=%@&types=%@",self.sku_id,self.types];
