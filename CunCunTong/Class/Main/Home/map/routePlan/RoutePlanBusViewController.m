...
{
    [super viewDidLoad];
    self.destinationCoordinate        = CLLocationCoordinate2DMake(40.018241, 116.418852);//奥北家园
    self.startCoordinate  = CLLocationCoordinate2DMake(39.903573, 116.473312);//广告产业园
