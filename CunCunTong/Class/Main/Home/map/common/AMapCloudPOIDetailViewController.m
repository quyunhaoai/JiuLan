...
- (NSString *)subTitleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0)
    {
        switch (indexPath.row)
        {
            case 0 : subTitle = [NSString stringWithFormat:@"%ld", (long)self.cloudPOI.uid];break;
            ...
            case 6 : subTitle = [NSString stringWithFormat:@"%ld(米)", (long)self.cloudPOI.distance];break;
            default: break;
        }
    }
    else if (indexPath.section == 1)
