...
//        __IPHONE_10_0
    ...
    }  //iOS10以上有效，等于YES则在通知中心显示的里面查找，等于NO则在待推送的里面查找；iOS10以下无效
...
- (void)networkDidReceiveMessage:(NSNotification *)notification {//收到消息非apns
    NSMutableDictionary * userInfomation = [[notification userInfo] mutableCopy];
    NSLog(@"----%@----",userInfomation);
}
//获取极光推送注册ID
