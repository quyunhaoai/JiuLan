...
+ (void)showStringPickerWithTitle:(NSString *)title
    ...
    [strPickerView.leftBtn setTitle:@"取消" forState:UIControlStateNormal];
...
- (NSAttributedString *)pickerView:(UIPickerView *)pickerView attributedTitleForRow:(NSInteger)row forComponent:(NSInteger)component{
    NSString *str = [_dataSourceArr objectAtIndex:_selectedRow];
    NSMutableAttributedString *AttributedString = [[NSMutableAttributedString alloc]initWithString:str];
    [AttributedString addAttributes:@{NSFontAttributeName:[UIFont fontWithName:@"PingFangSC-Medium" size: 24], NSForegroundColorAttributeName:COLOR_333333} range:NSMakeRange(0, [AttributedString  length])];
